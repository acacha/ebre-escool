...
<!-- Wizard -->
                    ...
                    <div class="col-xs-12 col-sm-3 center">
                      ...
                      <div id="student_photo" style="height: 150px;">
                        <span class="profile-picture">
                          <img style="height: 150px;" class="editable img-responsive editable-click editable-empty" src="https://localhost/ebre-escool/assets/img/alumnes/foto.png" alt="photo" />
                        </span>
                      </div>
                      <br />
    ...
    <script type="text/javascript">
      ...
      $(".btn-next").click(function(){
        ...
        //documentation : https://docs.jquery.com/Plugins/Validation/validate
