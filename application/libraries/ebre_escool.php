...
class ebre_escool  {
    ...
    public function user_is_admin() {
        ...
        if ($current_username == "jcaldero" || $current_username == "sergi" || $current_username == "sergitur" || $current_username == "pdavila" || $current_username == "rmelich" || $current_username == "jrodriguez" || $current_username == "admin") {
            return true;
        }
    ...
    //new funcion for inventory users in ebre-escool
