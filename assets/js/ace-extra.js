...
ace.settings = {
	...
	sidebar_collapsed : function(collpase) {
		console.debug('entrant a la funcio');
		...
		console.debug('assigns complete!');
		if(collpase) {
			console.debug('if esta colapsat! --->dooooo');
			ace.addClass(sidebar , 'menu-min');
			ace.removeClass(icon , $icon1);
			ace.addClass(icon , $icon2);

			try{ace.settings.set('sidebar', 'collapsed');}catch(e){console.debug('ERROR')}
			console.debug('if esta colapsat! --->FIN');
		} else {
			console.debug('else esta colapsat! --->dooooo');
			ace.removeClass(sidebar , 'menu-min');
			ace.removeClass(icon , $icon2);
			ace.addClass(icon , $icon1);

			try{ace.settings.unset('sidebar', 'collapsed') }catch(e){console.debug('ERROR')}
			console.debug('ELSE esta colapsat! --->FIN');
		}
